        ...
        new WebUI.Column({
          children:[
            ...
            new WebUI.Container({
              ...
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("3", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("4", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("5", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("6", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("7", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("8", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("9", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("0", {width: 55, height: 55}) ]
            })
          ]
        }),
        new WebUI.Column({
          children:[
            new WebUI.Container({
              ...
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("+", {width:55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
        ...
        new WebUI.Column({
          children:[
            new WebUI.Container({
              ...
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("i", {width:55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("e", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("pi", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("w", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("x", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("y", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("z", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("f", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("g", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
        ...
        new WebUI.Column({
          children:[
            new WebUI.Container({
              ...
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("exp", {width:55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("log", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("sqrt", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("sin", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("cos", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("tan", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("cross", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("det", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("CL", {width: 55, height: 55}) ]
            }),
            new WebUI.Container({
              desired_size:{width:70, height:60},
              horizontal_alignment: WebUI.Alignment.CENTER,
              vertical_alignment: WebUI.Alignment.CENTER,
              children: [ new WebUI.MyPushButton("EV", {width: 55, height: 55}) ]
            })
          ]
        })
      ]
...
WebUI.maxSize = function(size1, size2) {
    let max_size = {width: 0, height0: 0};
...
//
WebUI.Text = function(label,font_size,font_weight,text_color, properties) {
    WebUI.Widget.call(this, properties);
...
//String(this.position.left+radius) + ',' + String(this.position.top)
  let path = new fabric.Path('M' + radius + ',0' +
  function(){
    let arcPath = "";
    for(let i=0; i<divTimes; i++){
    ...
    for(let i=0; i<divTimes; i++){
      arcPath += 'L' + String(3*radius + radius*Math.sin(i*divAngle)) + ',' + String(radius+radius*Math.cos(i*divAngle));
    }
...
WebUI.clear_func = function(){
  expression = "0";
  WebUI.mainView.setLabel(expression);
}

WebUI.eval_func = function(){
  try{
    var result = WebUI.parser.eval(expression).toString();
